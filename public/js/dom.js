const SELECTORS = {
  ...
  memosTabButton: '#memos-tab-button',
  aiTabButton: '#ai-tab-button',
  managerLinkCount: '#manager-link-count',
  ...
  contextNoteScope: '#context-note-scope',
  contextNoteScopeHint: '#context-note-scope-hint',
  ...
  tasksRunnerHint: '#tasks-runner-hint',
  tasksWatchSection: '#tasks-watch-section',
  tasksWatch: '#tasks-watch',
  tasksWatchHint: '#tasks-watch-hint',
  tasksStatus: '#tasks-status',
  tasksRunForm: '#tasks-run-form',
  tasksRunButton: '#tasks-run-button',
  tasksStopButton: '#tasks-stop-button',
  tasksRunHint: '#tasks-run-hint',
  tasksFocus: '#tasks-focus',
  tasksFocusNow: '#tasks-focus-now',
  tasksFocusReason: '#tasks-focus-reason',
  tasksFocusUpdated: '#tasks-focus-updated',
  tasksAddForm: '#tasks-add-form',
  ...
  workspaceContextNoteScope: '#workspace-context-note-scope',
  workspaceContextNoteScopeHint: '#workspace-context-note-scope-hint',
  ...
  workspacePersonaInput: '#workspace-persona-input',
  workspacePersonaComposeButton: '#workspace-persona-compose-button',
  workspacePersonaUseButton: '#workspace-persona-use-button',
  workspacePersonaStopButton: '#workspace-persona-stop-button',
  workspacePersonaClearButton: '#workspace-persona-clear-button',
  ...
  dialogTargetLabel: '#dialog-target-label',
  dialogTargetPath: '#dialog-target-path',
  dialogTargetQuote: '#dialog-target-quote',
  dialogKind: '#dialog-kind',
  dialogKindHint: '#dialog-kind-hint',
  dialogFieldLabel: '#dialog-field-label',
  ...
  settingsAutoTasks: '#settings-auto-tasks',
